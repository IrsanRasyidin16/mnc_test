...
func (mercHandler MerchantHandler) GetAllMerchant(ctx *gin.Context) {
	merc, err := mercHandler.mercUseCase.GetAllMerchant()
	if err != nil {
...
func (mercHandler MerchantHandler) GetMerchantById(ctx *gin.Context) {
	...
	merc, err := mercHandler.mercUseCase.GetMerchantById(id)
	if err != nil {
...
func (mercHandler MerchantHandler) GetMerchantByName(ctx *gin.Context) {
	...
	merc, err := mercHandler.mercUseCase.GetMerchantByName(merchant.FullName)
	if err != nil {
...
func (mercHandler MerchantHandler) InsertMerchant(ctx *gin.Context) {
	...
	err = mercHandler.mercUseCase.InsertMerchant(merc, ctx)
...
func (mercHandler MerchantHandler) EditMerchant(ctx *gin.Context) {
	...
	err = mercHandler.mercUseCase.EditMerchantById(merc, ctx)
	if err != nil {
		appError := &utils.AppError{}
		if errors.As(err, &appError) {
...
func NewMerchantHandler(srv *gin.Engine, mercUseCase usecase.MerchantUseCase) *MerchantHandler {
	mercHandler := &MerchantHandler{
		mercUseCase: mercUseCase,
	}
